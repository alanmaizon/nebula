...
- `POST /projects/{project_id}/extract-requirements`
  ...
  - model identifier: `BEDROCK_MODEL_ID=amazon.nova-pro-v1:0` (or inference profile, e.g. `eu.amazon.nova-pro-v1:0`)
...
- `POST /projects/{project_id}/coverage`
  ...
  - model identifier: `BEDROCK_LITE_MODEL_ID=amazon.nova-lite-v1:0` (or inference profile, e.g. `eu.amazon.nova-lite-v1:0`)
  - artifact source tag: `nova-agents-v1`
