...
|---|---|---|
| Pipeline success rate | Successful critical endpoint responses / total critical endpoint calls in demo flow (`upload`, `extract`, `generate`, `coverage`, `export-json`, `export-md`) | Indicates operational reliability for judge/demo execution. |
