# Release Notes - v1.0.0 (2026-02-11)

## Summary
Nebula `v1.0.0` is the final submission-oriented release for the current roadmap cycle.

## Included in Final Release
- End-to-end workflow from upload to full-draft generation and export.
...
- Keep submission assets (video, narrative, testing instructions) synchronized.
